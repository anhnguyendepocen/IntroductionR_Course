...
- Create an APA style document using R markdown and the papaja package
...
devtools::install_github("crsh/papaja", build_vignettes = TRUE) # Install papaja from GitHub
```
