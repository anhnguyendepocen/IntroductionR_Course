...
papaja::apa_table(portugese.tbl, caption = "Mean Portugese exam scores separated by sex and school")
```
...
papaja::apa_table(portugese.tbl, caption = "Mean Math exam scores separated by sex and school.")
```
