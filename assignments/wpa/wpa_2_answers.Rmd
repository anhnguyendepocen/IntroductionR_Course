...
```{r, fig.cap = "A typical 3am scene at Paddy's in Basel.", eval = TRUE, out.width = "60%", fig.align = 'center', echo = FALSE}
...
```{r eval = TRUE, echo = TRUE, fig.width = 6, fig.height = 6, fig.align = 'center'}
