...
1. A short APA style report: https://dl.dropboxusercontent.com/u/7618380/phillips2017apa.Rmd. Here is the bibliography file `phillips2017apa_references.bib`: https://dl.dropboxusercontent.com/u/7618380/phillips2017apa_references.bib

2. An APA style tutorial on papaja: https://dl.dropboxusercontent.com/u/7618380/apa_example.Rmd. Here is the bibliography file `r-references.bib`: https://dl.dropboxusercontent.com/u/7618380/r-references.bib
...
knitr::include_graphics("https://dl.dropboxusercontent.com/u/7618380/papaja_ss1.png")
```

```{r, out.width = "400px", echo = FALSE}
knitr::include_graphics("https://dl.dropboxusercontent.com/u/7618380/papaja_ss2.png")
```

When you click ok, you should see a new document like this open

```{r, out.width = "400px", echo = FALSE}
knitr::include_graphics("https://dl.dropboxusercontent.com/u/7618380/papaja_ss3.png")
```
...
You add R chunks and inline code to a document using basic Markdown. Check out examples at https://dl.dropboxusercontent.com/u/7618380/phillips2017apa.Rmd and the Markdown guide at http://rpubs.com/YaRrr/markdownbasics.
